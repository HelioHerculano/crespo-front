         ...
         */ !(function (s, r) {
          ...
          (i = function () {
            var t,
              ...
              I = function (t) {
                p.count++,
                  1 < p.count && (p.multitouch = !0),
                  (p.startX = t.changedTouches[0].pageX),
                  (p.startY = t.changedTouches[0].pageY);
              },
              T = function (t) {
                if (!m && !p.multitouch) {
            ...
            function D(o, s) {
              if (h !== o) {
                ...
                for (
                  var r, a = [], c = [], f = (g.length = 0);
                  f < o.length;
                  f++
                )
                  ((r = U("div")).className = "full-image"),
                    (r.id = "baguette-img-" + f),
                    g.push(r),
                    a.push("baguetteBox-figure-" + f),
                    c.push("baguetteBox-figcaption-" + f),
                    e.appendChild(g[f]);
                t.setAttribute("aria-labelledby", a.join(" ")),
                  t.setAttribute("aria-describedby", c.join(" "));
              }
            }
            function A(e) {
              l.noScrollbars &&
                ...
                "block" !== t.style.display &&
                  ...
                  l.onChange && l.onChange(f, g.length),
                ...
                }),
              {
                run: function (l, u) {
                  return (
                    ...
                    (function () {
                      if ((t = Y("baguetteBox-overlay")))
                        return (
                          (e = Y("baguetteBox-slider")),
                          (n = Y("previous-button")),
                          (i = Y("next-button")),
                          void (o = Y("close-button"))
                        );
                      (t = U("div")).setAttribute("role", "dialog"),
                        (t.id = "baguetteBox-overlay"),
                        document.getElementsByTagName("body")[0].appendChild(t),
                        ((e = U("div")).id = "baguetteBox-slider"),
                        t.appendChild(e),
                        (n = U("button")).setAttribute("type", "button"),
                        (n.id = "previous-button"),
                        n.setAttribute("aria-label", "Previous"),
                        (n.innerHTML = c.svg ? s : "&lt;"),
                        t.appendChild(n),
                        (i = U("button")).setAttribute("type", "button"),
                        (i.id = "next-button"),
                        i.setAttribute("aria-label", "Next"),
                        (i.innerHTML = c.svg ? r : "&gt;"),
                        t.appendChild(i),
                        (o = U("button")).setAttribute("type", "button"),
                        (o.id = "close-button"),
                        o.setAttribute("aria-label", "Close"),
                        (o.innerHTML = c.svg ? a : "&times;"),
                        t.appendChild(o),
                        (n.className =
                          i.className =
                          o.className =
                            "baguetteBox-button"),
                        (function () {
                          var s = c.passiveEvents ? { passive: !1 } : null,
                          ...
                          if (
                            ...
                            [].forEach.call(n, function (t, n) {
                              var i = function (t) {
                                ...
                                s = { eventHandler: i, imageElement: t };
  ...
  (n.n = (t) => {
    ...
    (() => {
        ...
        off: function (t, e) {
          ...
          if (i && e)
            for (var s = 0, r = i.length; s < r; s++)
              i[s].fn !== e && i[s].fn._ !== e && o.push(i[s]);
          return o.length ? (n[t] = o) : delete n[t], this;
        },
      }),
        (d.exports = p),
        (d.exports.TinyEmitter = p);
      var m = d.exports,
        ...
        g = function (t, e) {
          ...
          for (
            var n = t.parentNode.querySelectorAll(e), i = 0;
            i < n.length;
            i++
          )
            if (n[i] == t) return !0;
            ...
            l(t, [
              {
                ...
                value: function () {
                  (this.isVisible = !0),
                    this.element.classList.remove(I.HIDDEN),
                    this.element.classList.add(I.VISIBLE),
              ...
              },
              {
                ...
                value: function () {
                  (this.isVisible = !1),
                    this.element.classList.remove(I.VISIBLE),
                    this.element.classList.add(I.HIDDEN),
              ...
              },
              {
                key: "init",
                value: function () {
                  this.addClasses([I.SHUFFLE_ITEM, I.VISIBLE]),
              ...
              },
              {
                key: "dispose",
                value: function () {
                  this.removeClasses([I.HIDDEN, I.VISIBLE, I.SHUFFLE_ITEM]),
            ...
            : ("function" == typeof n.by
                ? t.sort(function (t, e) {
                    ...
                    return void 0 === i && void 0 === s
                      ? ((o = !0), 0)
                      : i < s || "sortFirst" === i || "sortLast" === s
                      ? -1
                      : i > s || "sortLast" === i || "sortFirst" === s
                      ? 1
                      : 0;
                  })
                : "function" == typeof n.compare && t.sort(n.compare),
              o ? i : (n.reverse && t.reverse(), t))
          : [];
      }
      var A = {},
        M = "transitionend",
      ...
      function F(t) {
        return (
          !!A[t] &&
          (A[t].element.removeEventListener(M, A[t].listener),
          (A[t] = null),
          !0)
        );
      }
      function z(t, e) {
        ...
        return (
          t.addEventListener(M, i), (A[n] = { element: t, listener: i }), n
        );
      }
      function B(t) {
      ...
      function R(t, e) {
        for (
          var n, i = ((n = t), Math.min.apply(Math, n)), o = 0, s = t.length;
          o < s;
          o++
        )
          ...
          Object.keys(n).forEach(function (t) {
            ...
            if (c > 0) {
              ...
              (f = r.every(function (t) {
                var e = new k(t.left + c, t.top, t.width, t.height, t.id),
                  n = !i.some(function (t) {
            ...
            var i,
              o =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : {};
            r(this, n),
              ((i = e.call(this)).options = Object.assign({}, n.options, o)),
              i.options.delimeter &&
                (i.options.delimiter = i.options.delimeter),
              (i.lastSort = {}),
              (i.group = n.ALL_ITEMS),
              (i.lastFilter = n.ALL_ITEMS),
              (i.isEnabled = !0),
              (i.isDestroyed = !1),
              (i.isInitialized = !1),
              (i._transitions = []),
              ...
              [
                {
                  ...
                  value: function () {
                    if (
                      ...
                      this.element.classList.add(n.Classes.BASE),
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    return Array.isArray(t)
                      ? this.options.filterMode === n.FilterMode.ANY
                        ? t.some(s)
                        : t.every(s)
                      : o.includes(t);
                  },
                      ...
                      0 ===
                        (i =
                          "function" == typeof this.options.columnWidth
                            ...
                            : this.options.sizer
                            ? n.getSize(this.options.sizer).width
                            : this.options.columnWidth
                            ? this.options.columnWidth
                            : this.items.length > 0
                            ? n.getSize(this.items[0].element, !0).width
                            : t) && (i = t),
                      i + e
                    );
                  },
                },
                {
                  ...
                  value: function (t) {
                    return "function" == typeof this.options.gutterWidth
                      ...
                      : this.options.sizer
                      ? O(this.options.sizer, "marginLeft")
                ...
                },
                {
                  ...
                  value: function () {
                    var t =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ? arguments[0]
                          : n.getSize(this.element).width,
                      e = this._getGutterSize(t),
                      i = this._getColumnSize(t, e),
                      o = (t + e) / i;
                    Math.abs(Math.round(o) - o) <
                      this.options.columnThreshold && (o = Math.round(o)),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    t.forEach(function (t, o) {
                      ...
                      if (w.equals(t.point, n[o]) && !t.isHidden)
                        return t.applyCss(S.Css.VISIBLE.before), void s();
                      (t.point = n[o]),
                        (t.scale = S.Scale.VISIBLE),
                        (t.isHidden = !1);
                      var r = e.getStylesForTransition(t, S.Css.VISIBLE.before);
                      (r.transitionDelay = e._getStaggerAmount(i) + "ms"),
                        e._queue.push({ item: t, styles: r, callback: s }),
                        (i += 1);
                    });
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    e.forEach(function (e) {
                      ...
                      if (e.isHidden)
                        return e.applyCss(S.Css.HIDDEN.before), void i();
                      (e.scale = S.Scale.HIDDEN), (e.isHidden = !0);
                      var o = t.getStylesForTransition(e, S.Css.HIDDEN.before);
                      (o.transitionDelay = t._getStaggerAmount(n) + "ms"),
                        t._queue.push({ item: e, styles: o, callback: i }),
                        (n += 1);
                    });
                  },
                },
                  ...
                  value: function () {
                    ...
                    e && t && this.isInitialized
                      ...
                      ? (this._styleImmediately(this._queue),
                        this._dispatch(n.EventType.LAYOUT))
                      : this._dispatch(n.EventType.LAYOUT),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (t.length) {
                      ...
                      this._toggleFilterClasses({ visible: [], hidden: o }),
                        this._shrink(o),
                        this.sort(),
                        ...
                        this._updateItemCount(),
                        this.once(n.EventType.LAYOUT, function () {
                          e._disposeItems(o),
                            i.forEach(function (t) {
                              t.parentNode.removeChild(t);
                            }),
                            e._dispatch(n.EventType.REMOVED, { collection: i });
                        });
                    }
                  },
                },
      ...
      (W.ShuffleItem = S),
        ...
        (W.__sorter = D),
        (W.__getColumnSpan = N),
        (W.__getAvailablePositions = j),
        (W.__getShortColumn = R),
        (W.__getCenteredPositions = H);
      const Y = W;
      function U(t, e) {
        var n = Object.keys(t);
        if (Object.getOwnPropertySymbols) {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        s(".gallery_content-media"),
          G(".gallery_content-media", ".gallery_content-filters_filter", {
