                ...
                }),
              {
                run: function (l, d) {
                  return (
                    ...
                    (function () {
                      if ((e = W("baguetteBox-overlay")))
                        return (
                          (t = W("baguetteBox-slider")),
                          (s = W("previous-button")),
                          (n = W("next-button")),
                          void (i = W("close-button"))
                        );
                      (e = R("div")).setAttribute("role", "dialog"),
                        ...
                        e.appendChild(t),
                        (s = R("button")).setAttribute("type", "button"),
                        ...
                        (n.innerHTML = c.svg ? a : "&gt;"),
                        e.appendChild(n),
                        (i = R("button")).setAttribute("type", "button"),
                        (i.id = "close-button"),
    ...
    (() => {
          ...
          for (let i = 0; i < p; i += 1) {
            ...
            if (
              ...
              if ("auto" === n.slidesPerView) {
                ...
                (E = (r - (n.slidesPerView - 1) * w) / n.slidesPerView),
                  n.roundLengths && (E = Math.floor(E)),
      ...
      const G = {
        loopCreate: function () {
          ...
          for (let e = a.length - 1; e >= 0; e -= 1)
            i.prepend(w(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      const X = {
          attachEvents: function () {
            ...
            (e.onTouchStart = j.bind(e)),
              ...
              (e.onClick = V.bind(e)),
              n.touch && !W && (t.addEventListener("touchstart", R), (W = !0)),
              Y(e, "on");
          },
      ...
      function oe(e) {
        for (var t = 1; t < arguments.length; t++) {
          var s = null != arguments[t] ? arguments[t] : {};
          t % 2
            ? ae(Object(s), !0).forEach(function (t) {
                le(e, t, s[t]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(s))
            : ae(Object(s)).forEach(function (t) {
                Object.defineProperty(
                  e,
                  t,
                  Object.getOwnPropertyDescriptor(s, t)
